...
///
/// <para><b>Mimari karar (F.6 C.1 cleanup):</b> Flat <c>GetAllAsync</c> geri alındı.
/// Site işlemleri daima Organization context altında yapılır. Kullanıcı önce
/// Organization seçer, sonra o org'un Site listesine iner.</para>
/// </summary>
public interface ISitesApi
{
    /// <summary>
    /// <c>GET /api/organizations/{orgId}/sites?page&amp;pageSize&amp;search&amp;includeInactive</c>
    /// <para>Bir Organization'a ait Site'lar (nested). UI akışı: "Firma → Siteler".
    /// Response'ta her satırda <c>OrganizationName</c> dolu gelir (breadcrumb/başlık için).</para>
    /// </summary>
